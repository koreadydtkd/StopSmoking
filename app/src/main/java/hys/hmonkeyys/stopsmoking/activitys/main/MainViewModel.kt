...
internal class MainViewModel(
    ...
    override fun fetchData(): Job = viewModelScope.launch {
        elapsedDate = getDDay()
        inputAmountOfSmoking = preferenceManager.getInt(AppShareKey.AMOUNT_OF_SMOKING_PER_DAY)
    ...
    fun getDDay(): Int {
        val stopSmokingDate = preferenceManager.getString(AppShareKey.STOP_SMOKING_DATE) ?: return -1
    ...
    fun getTobaccoPrice(): String {
        val inputPrice = preferenceManager.getInt(AppShareKey.TOBACCO_PRICE)
    ...
    fun getDefaultFeed(): FeedTemplate {
        ...
        return FeedTemplate(
            content = Content(
                ...
                imageUrl = preferenceManager.getString(FIREBASE_IMAGE_URL) ?: "",
                link = Link(
    ...
    /** 닉네임 가져오기 */
    fun getNickName(): String = preferenceManager.getString(AppShareKey.NICK_NAME) ?: "Error"

    /** 각오 가져오기 */
    fun getMyResolution(): String = preferenceManager.getString(AppShareKey.MY_RESOLUTION) ?: "Error"
